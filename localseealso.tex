...
\il{Chiwere-Winnebago| see {Ho-Chunk-Jiwere}}
...
\il{Jiwére| see {Otoe}}
\il{Jiwere-Ho-Chunk| see {Ho-Chunk-Jiwere}}
\il{Kaáⁿze| see {Kanza}}
\il{Káⁿze| see {Kanza}}
\il{Kansa| see {Kanza}}
\il{Kaw| see {Kanza}}
...
\il{Proto-Siouan-Catawban| see {Proto-Siouan}}
...
\il{Winnebago-Chiwere| see {Ho-Chunk-Jiwére}}
\is{writing system| see {orthography}}
\il{Yesánq| see {Tutelo}}
\il{'Iipay Aa| see {Diegueno}}

%NAKO[DT]A should render Nakoda see Stoney; Nakota with 2 page refs, see Assiniboine, see also Dakotan, Stoney
\il{Nakoda| see {Stoney}}
\il{Nakota| see {Assiniboine}, see also {Dakotan, Stoney}}

%SEE ALSO - just putting in a couple for now to see how they render
\il{Western Muskogean| see also {Muskogean}}
\il{Muskogean| see also {Western Muskogean}}
