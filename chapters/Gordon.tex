...
Carter, R. T., Jr. \REF{ex:gordon:1991} Old Man Coyote and the Wild Potato: A Trickster tale. \emph{Linguistic studies presented to John L. Finlay: Algonquian and Iroquoian Linguistics} 8, pp. 27--43. University of Manitoba.
...
GoodTracks, Jimm G. \REF{ex:gordon:2004} \emph{Baxoje -- Jiwere Ich\^{}e, Ioway Otoe Language CD II} with accompanying text.
...
Gumperz, John J. \REF{ex:gordon:1982} \emph{Discourse strategies}. Cambridge U. Press.

Gundel, Jeanette K. \REF{ex:gordon:1988} Universals of topic-comment structure. \emph{Studies in Syntactic Typology} 209--39.

Gundel, Jeanette K. \REF{ex:gordon:2003} Information structure and referential givenness/newness: How much belongs in the grammar? In Stefan Müller (Ed.) \emph{Proceedings, HPSG03}, East Lansing, MI. CSLI Publications (electronic version).
...
Kaufman, David V. \REF{ex:gordon:2008} Focality and topicality marking in Biloxi. \emph{Kansas Working Papers in Linguistics} 30: 150--8.

Kennard, E. A. \REF{ex:gordon:1936} Mandan grammar. \emph{IJAL} 9: 1--43.

Koontz, John E. \REF{ex:gordon:2003} A focus marker in Omaha-Ponca (Dhegiha Siouan). Siouan and Caddoan Languages Conference.
...
Marsh, Gordon H. \REF{ex:gordon:1936}. Manuscript collection. Philadelphia, American Philosophical Society.

Mirzayan, \citet{Armik2011} \emph{Lakota intonation and prosody}. U. Colorado dissertation.

Mixco, Mauricio J. \REF{ex:gordon:1997} Mandan switch-reference: a preliminary view. \emph{Anthropological Linguistics} 39: 220--98.

Oliverio, Giulia R. M. \REF{ex:gordon:1996} \emph{A grammar and dictionary of Tutelo}. U. Kansas dissertation.

Parks, Douglas R., A. Wesley Jones \& Robert C. Hollow (Eds) \REF{ex:gordon:1978} \emph{Earth lodge tales from the upper Missouri}. Bismarck, ND: Mary College.

Pierrehumbert, Janet B. \REF{ex:gordon:1980} \emph{The phonology and phonetics of English intonation}. MIT dissertation.
...
de Reuse, Willem J. \REF{ex:gordon:1994} Noun incorportation in Lakhota Siouan. \emph{IJAL} 60: 199--260.

Rood, David S. \REF{ex:gordon:1977} Some Lakhota presuppositions. \emph{Colorado Research in Linguistics} 7.

Rood, David S. \REF{ex:gordon:1985} Definiteness subcategorized in discourse: Lakhota kˀų. \emph{Kansas Working Papers in Linguistics} 10: 144--83.

Rudin, \citet{Catherine1998} Postverbal constituents in Omaha-Ponca. Bloomington, IN: Siouan and Caddoan Languages Conference. 

Wallace, Karen K. \REF{ex:gordon:1993} \emph{Verb incorporation and agreement in Crow}. UCLA dissertation.
...
Wolvengrey, A. \REF{ex:gordon:1990} A marker of focus in Mandan discourse. Mid America Linguistics Conference.
