...
VPE can also target other internal arguments. Both indirect objects and resultative phrases are typically analyzed as VP-internal (see e.g., \citealt{Larson1988} and Levin and Rappaport \citealt{Hovav1995}), and they are also subject to VPE. The ditransitive example in \REF{ex:johnson:5} shows that both a direct object and indirect object can be contained in the ellipsis site.
...
\begin{exe}
\ex[*] {
I've never ridden a camel$_i$, and it$_i$ stank horribly. (Hankamer \& \citealt[404]{Sag1976})}
\end{exe}
