...
<<<<<<< HEAD
\item{Wab\'uhge hi\textsuperscript{n}ñí\textipa{N}e ke. `I'm out of bread.'}
...
\item{(Ch\'u\textsuperscript{n}ha\textsuperscript{n}we) Tá\textsuperscript{n}grigi gas\'u\textsuperscript{n} waná\textsuperscript{n}xi ñí\textipa{N}eñe ke. Gas\'u\textsuperscript{n} yá\textsuperscript{n} híwe re. `Now there are no ghosts outside (the window), so go to sleep now.'}
...
\item{Gas\'u\textsuperscript{n}da ihápahu\textipa{N}e ke.	 `I already know that.'}
\item{}
\end{list} 
