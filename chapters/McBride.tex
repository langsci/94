...
\ea \label{ambiguity}
\ea \label{ambiguity1}{K\'oⁿblamazhi.
\gll 
$\varnothing$-k-(g)oⁿ-bl-(y)a-$\varnothing$?-mazhi-$\varnothing$? \\
\textsc{3cn-1sg.agt}-want\textsubscript{1}-\textsc{1sg.agt}-want\textsubscript{2} \\ 
\gll `I do not wish it.' (KR, p. 188) 
}
\ex \label{ambiguity2}{Ph\'im\`azhi
\gll 
ph-(h)i-$\varnothing$?-mazhi-$\varnothing$?  \\
...
\midrule
K\'oⁿblamazhi. & $\varnothing$-k-(g)oⁿ-bl-(y)a & -$\varnothing$? & -mazhi & -$\varnothing$? \\
Ph\'im\`azhi & ph-(h)i & -$\varnothing$? &  -mazhi & -$\varnothing$?  \\
\lspbottomrule
\end{tabular}
\end{table}
