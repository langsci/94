...
\subsection{Nominalized verbal possessive constructions}\label{nomvposs}
...
\subsection{Hidatsa}\label{hidatsa}
\subsubsection{The possessor}
...
\subsection{Mandan}\label{mandan}
...
\subsection{Lakota}\label{lakota}
\subsubsection{The possessor}
...
\subsection{Biloxi}\label{biloxi}
