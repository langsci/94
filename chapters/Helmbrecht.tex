...
The semantic/syntactic properties of the possessor and their possible effects on the choice of the PC are not discussed and described in Mixco's grammatical sketch (\citealt{Mixco1997}). However, looking into the appended Mandan text, it seems that juxtapositions are possible in case  the possessor is a lexical noun. There is at least one clear example of this construction (cf. \REF{villagechief}) that shows that association may be expressed by this PC.
...
The PCs in \REF{lakotalandwisdom} contain a marker for possession \textit{t\v{h}á-} `POSS' which is attached to the possessed noun and preceded by the pronominal affix of the possessor. This marker is common Siouan (cf. \citealt{RankinEtAl2015}). If there are lexical nouns expressing the possessor, the following PCs are used.
...
\subsubsection{The possessed}
There are different PCs according to the semantic type of the possessed noun; body part terms are simply affixed by the pronominal series of undergoer prefixes. Among the body part terms, there is a split between body parts that are ``conceived as particularly subject to willpower" (\citealt[128]{BoasDeloria1941}), and the others. Buechel (1939:100) describes this difference as ``possession of one's incorporeal constituents" versus ``possession of one's body and its physical parts"; compare the examples in \REF{lakotaincorporeal} and \REF{lakotabody}.
...
\begin{table}
\caption{Alienable vs. inalienable distinction in Lakota (\citealt[127-33]{BoasDeloria1941})} \label{lakotaalienability}
\small
...
\nocite{Barker1995,Baron2001,ChappellEtAl1996,Comrie1981,Heine2001,Ingham2003,Koontz1984,KunoKaburaki1977,Lehmann1998,LevyBruhl1914,Lowie1941,Martin1993,Matthews1965,Oliverio1996,Rankin2002,Rankin2004,Rakin2005a,Rankin2005b,Rice1989,Sorensen,StolzEtAl,Susman1943,Ultan1978,VanValin1977,WhiteEagle1988,Whitman1947}
