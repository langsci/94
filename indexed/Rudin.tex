...
Coordinate constructions may or may not contain an overt coordinating \isi{conjunction}, a word translating as `and,' `or,' `but', etc. If there is one, it may occur between the conjuncts, or after the last one, or may be repeated (before or after each conjunct):
