...
\ex\label{ex:rood:2}
 \begin{xlist}
\ex \textit{wa\textipa{N}<\v{z}íg>\v{z}ila} `one at a time' (reduplication of \textit{wa\textipa{N}\v{z}íla} `one')
...
\ex \textit{sá\textipa{N}m} < \textit{sá\textipa{N}p\v{h}a} `beyond; more than' (\textit{sa\textipa{N}} `?'; \textit{-p\v{h}a}  `adverbial')
\end{xlist}
\end{exe}
...
\ex Stops nasalize\is{nasalization} ([\textipa{N}] in square brackets represents the velar nasal; parentheses mark optionality):

\textit{\v{s}u\textipa{N}[\textipa{N}](g)'áka\textipa{N}ya\textipa{N}kA} `ride horseback' (\textit{\v{s}ú\textipa{N}ka} `horse' + \textit{aká\textipa{N}} `on' + \textit{ya\textipa{N}\-kÁ} `sit') (also pronounced \textit{\v{s}u\textipa{N}k'áka\textipa{N}ya\textipa{N}ke}; see section 4.2 below for explanation)

\textit{nu\textipa{N}mnú\textipa{N}pa} `two at a time' (reduplication of \textit{nú\textipa{N}pa} `two')

\textit{wa\textipa{N}yá\textipa{N}[\textipa{N}](g) wahí} `I have come to see him' (\textit{wa\textipa{N}yá\textipa{N}kA} `to see', \textit{wa-} `I' + \textit{hí} `arrive coming')
\end{xlist}
\end{exe}
...
\ex \textit{blA} + \textit{i\textipa{N}}-\isi{ablaut} > *\textit{bli\textipa{N}}\footnote{Actually, there is one extended family on the Pine Ridge reservation that does say \textit{bli\textipa{N} kte}, to the amusement of many others.} > \textit{mni\textipa{N}} (example: \textit{mní\textipa{N} kte} `I will go')
\ex \textit{glA} `go home' + \textit{i\textipa{N}}-\isi{ablaut} > *\textit{gli\textipa{N}} > \textit{gní\textipa{N}} (example: \textit{gní\textipa{N} kte} `he will go home')
\end{xlist}
\end{exe}
...
\ex \textit{\v{s}ú\textipa{N}.ka} `dog' + \textit{má.ni.tu} `wilderness' > \textit{\v{s}u\textipa{N}[\textipa{N}](g).má.ni.tu} `coyote'
\end{xlist}
\end{exe}
