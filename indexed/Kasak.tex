...
Both \ili{Proto-Siouan} and \ili{Catawba} have some reflex of /wi-/ as their non-personal classifier. \ili{Catawba} and \ili{Proto-Siouan} both use *wi- not only to mark animals, but also common foods and weather- and nature-related words. \ili{Yuchi}, on the other hand, has \emph{we-}; see Table \ref{yuchinonpersonal}.
