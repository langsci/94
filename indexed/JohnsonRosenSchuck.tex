...
\il{Ho-Chunk}Hocąk also does not possess negative\is{negation} quantifiers: instead, the equivalents to `nothing' and `nobody' are expressed through a combination of clausal \isi{negation} and indefinite pronouns. This is shown in \REF{ex:jrs:20a)}and \REF{ex:jrs:20b)}, respectively.
