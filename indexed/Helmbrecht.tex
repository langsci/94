...
\title{{NP}-internal possessive constructions in {Hoocąk} and other {Siouan} languages}
 \rohead{{NP}-internal possessive constructions in {Siouan} languages}
...
& \\
 & pronominal index on \isi{possessed} noun   (\isi{possessor} marking on  \isi{possessed}) & \ili{Mam} \citep[142]{England1983} \\
&                        &\parbox{7cm}{
...
& \\
& mixed strategy (genitive case marking plus pronominal index)& \ili{Turkish} \citep[633]{Kornfilt1990} \\
&                        &\parbox{7cm}{
...
& \\
& nominalized predicative possession & \il{Ho-Chunk}Hoocąk \citep[19]{Helmbrecht2003} \\
&                        &\parbox{7cm}{
			hicųwį́ waháara \\
...
\textit{mi-ná\v{g}i ki\textipa{N} } \hspace{2.11em}		`my souls'

\textit{mi-\v{c}há\v{z}e  ki\textipa{N} } \hspace{1.85em} `my name'
...
\textit{ma-íšta ki\textipa{N} }	 \hspace{2.11em}	`my eye'

\textit{ma-sí ki\textipa{N} }		 \hspace{3.02em}	`my foot'
