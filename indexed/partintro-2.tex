...
Jimm Goodtracks\ia{Goodtracks, Jimm G.}, Bryan James Gordon\ia{Gordon, Bryan James}, and Saul Schwartz\ia{Schwartz, Saul} (``Perspectives on \il{Ioway, Otoe-Missouria}Chiwere revitalization'') present a three-pronged, personal account of their individual and collective involvements with the \il{Ioway, Otoe-Missouria}Chiwere (also known as Báxoje Jiwére \~{N}út\^{}achi, or \ili{Ioway} and \ili{Otoe}-Missouria) language. In separate, individually-written sections, each author gives a unique view of past, present, and future prospects of \il{Ioway, Otoe-Missouria}Chiwere, drawn from their various roles as Elder, teacher, dictionary-compiler, language-nest participant, researcher, and language-program director. 
