...
The case of the \ili{Dhegiha} Siouan language \ili{Kansa} (also known as \ili{Kanza} or \ili{Kaw}) is precisely as described above. Dorsey's 1880s-era \isi{field work} yielded a rather large set of slip files, two dozen texts collected from nine separate consultants, and hundreds of pages of ethnographic notes, all of which Rankin used in his own extensive work with the last \ili{Kansa} speakers in the 1970s and early 1980s. Following the deaths of his consultants, Rankin continued working on \ili{Kansa} for the rest of his life. Neither Dorsey\ia{Dorsey, James Owen} nor Rankin\ia{Rankin, Robert L} intended their work to be used as-is for revitalization and \isi{curriculum development} purposes, but this is what happened: Such efforts must begin somewhere, and their material was the logical starting point. Fortunately, Rankin was willing to contribute to this enterprise, and he often worked on Siouan language \isi{pedagogy} side-by-side with other linguists (these included myself and several other contributors to this volume), both in the classroom and behind the scenes. Yet, even with Rankin --- himself a lifelong educator --- and a team of Siouanists at the head of \ili{Kansa} \isi{language classes}, the learner outcomes were often far less than could be expected of other beginning \isi{language classes}; the source material was simply incomplete. As a consequence, many basic things remain unknown for \ili{Kansa} and, accordingly, unused among language learners.
 
Consider a common \ili{English} expression such as `She \textit{wouldn't} go, `Mike \textit{wouldn't} do that,' `they \textit{wouldn't} give it to me,' or the like. To my knowledge, there is no recorded translation of this expression in the available \ili{Kansa} materials. I honestly cannot recall the exact circumstances of how this lacuna was discovered, but I remember that it came up in the \ili{Kaw} Nation's Thursday night community language class in \ili{Kaw} City, Oklahoma, in the mid-2000s. Perhaps some thoughtful student simply asked, ``How do you say, `she wouldn't go,' in the language?'' Surely I knew that the answer to the question would involve post-verbal \isi{negation} and some use of both the potential and non-continuative enclitics, but I was flummoxed as to how to order these elements. Whatever the circumstances may have been, once it became apparent that I could not immediately provide an answer based on my working knowledge of \ili{Kansa} \isi{syntax}, I probably explained that I would have to do more research and return with a definite solution later. Little did I know then that I \textit{wouldn't} have a satisfying answer the next week, month, or even year!

Part of the problem lies in just how one would go about trying to find the answer. It would ideally involve reviewing the available texts and field elicitations with an eye toward finding how Dorsey\ia{Dorsey, James Owen}, Rankin\ia{Rankin, Robert L.}, or someone else may have recorded it. Those working on \ili{Kansa} have, of course, done a great deal of secondary research like this; the lacunae are numerous, the learners are curious, and the available scholarly analysis is of high quality. Nevertheless, the construction does not appear in the materials. Failing that, the next step would involve reconstructing the form from a set of near-matches combined with knowledge of the language's \isi{syntax}. Yet, \isi{syntax} is one area where \ili{Kansa} and the other \ili{Dhegiha} languages are not always described in the greatest detail. Both Rankin's brief grammatical sketch of \ili{Kansa} \citeyear{Rankin1989} and his later sketch of \ili{Quapaw} \citeyear{Rankin2005b} discuss a variety of \isi{syntax} topics, as does \citegen{Quintero2004} book-length grammar of \ili{Osage}. But all of these works are overviews of \ili{Dhegiha} grammar, and are ultimately too general to offer fine-grained perspective on such a specific question. 

In this chapter, I will attempt a basic generative syntactic analysis of \ili{Kansa} post-verbal \isi{negation}. Bear in mind that I am ultimately looking for a pedagogical solution, not a theoretical one. As such, I do not advocate any particular theory of formal \isi{syntax} and feel fairly free to borrow liberally from several eras of transformational grammar all at once. I am fully aware that this juxtaposition of concepts may make my analysis problematic for strict syntacticians, and perhaps also for dedicated pedagogues who may find any such analysis tedious to begin with. I do this not to alienate potential readers or to break any new theoretical ground, but simply to predict an unattested enclitic order using the formal means within my disposal. I also hope that my analysis and the discussion that follows will help to shed some light on a few philosophical principles that I consider very important to anyone working in Siouan languages:
...
\ili{Kansa} \isi{syntax} involves the use of post-verbal negative (\textsc{neg}) enclitics, particularly as used in different aspect combinations. \ili{Kansa} \textsc{neg} has two separate forms: It appears either as \textit{-(a)zhi} or \textit{-mazhi}, the latter of which is only used with 1s subjects. 
...
\begin{figure}
\caption{Contradictions of \ili{Kansa} \textsc{neg} placement} \label{contradictions}
...
\Tree [ .TP [ .\hspace{2em}DP\\{[+\textsc{nom; +1sg}]} ] [ .T$'$ [ .ContP [ .Cont$'$ [ .PotP [ .Pot$'$ [ .NegP [ .Neg$'$ [ .\isi{VP} \edge[roof]; {\textit{t\textsubscript{i}} \hspace{1em} ashkáⁿ} ] [ . Neg\\-mazhi ] ] ] [ .Pot\\ta ] ] ] [ .Cont\\miⁿkhe ] ] ] [ .\hspace{1.5em}T\\{[+\textsc{nom}]} ] ] ]
\end{tikzpicture}
\end{center}
\end{figure}
...
\Tree [ .TP [ .\hspace{2em}DP\\{[\textsc{+nom; +3cn}]} ] [ .T$'$ [ .NegP [ .Neg$'$ [ .contP [ .ncont$'$ [ .\isi{VP} \edge[roof]; {\textit{t\textsubscript{i}} \hspace{1em} shk\k{á}} ] [ .ncont\\-(a)be ] ] ] [ .Neg\\-(a)zhi ] ] [ .\hspace{1.5em}T\\{[\textsc{+nom}]} ] ] ] ]
\end{tikzpicture}
\end{center}
\end{figure}
